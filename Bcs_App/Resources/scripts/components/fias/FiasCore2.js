(function (factory) {
    ...
    Fias.prototype = {
		...
		if (document.getAddress !== undefined) {
                    updateFias(self.main.attr('data-id'), document.getAddress)             
                    self.main.find('textarea').val(document.getAddress.fulladdress);
                    self.main.find('textarea').keyup();
                    self.main.parent().parent().parent().parent().parent().parent().parent().addClass('questionCompleted');
                }
                else self.main.parent().parent().parent().parent().parent().parent().parent().removeClass('questionCompleted');                
